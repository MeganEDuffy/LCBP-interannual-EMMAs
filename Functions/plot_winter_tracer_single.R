...
# Core function to plot a single site's winter tracer stack
plot_winter_tracer_single <- function(site_name,
                                       water_year = 2023,
                                       event_bounds = NULL,
                                       q_file,
                                       chem_data_dir,
  ...
  # Color mapping (Updated Precip -> Rain)
  source_colors <- c(
    "Streamwater"              = "blue",
    "Baseflow"                 = "skyblue3",
  ...
  # Shape mapping (Updated Precip -> Rain)
  source_shapes <- c(
    "Streamwater"              = 1,
    "Baseflow"                 = 17,
    "Groundwater"              = 18,
  ...
  # Stack panels vertically, add overall title and unified bottom legend
  site_stack <- wrap_plots(geochem_plots, ncol = 1) +
    plot_layout(guides = "collect") +
    plot_annotation(
      title = paste0(site_name, " Brook — Winter ", water_year, " Tracers"),
      theme = theme(
